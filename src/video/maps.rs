...
//!
//! Ships 720p (48×48) and 1080p (72×72) Gemini diamond maps, derived from
...
/// Grayscale diamond preview (48×48×3), alpha-shaped mid-gray.
...
///
/// No authentic 44×44 map is shipped; returns `None`.
...
///
/// Same source as the 720p map, LANCZOS-scaled to 72×72
