//! Reproduce dark-fabric ROI box bug → rust-crate-test/bugfix-roi/
...
fn main() {
    ...
    let out_dir = PathBuf::from("/workspace/rust-crate-test/bugfix-roi");
    ...
    let clips = [
        ...
        // textured fabric regression check
        (
    ...
    // Also copy GWT ref if present
    let gwt = PathBuf::from("/workspace/rust-crate-test/quality-v3/8e9d4f77_gwt.mp4");
    if gwt.is_file() {
