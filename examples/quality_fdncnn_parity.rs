//! quality-fdncnn-parity: GWT-parity FDnCNN (no classical post) on 8e9d4f77.
...
fn main() {
    ...
    let out = Path::new("/workspace/rust-crate-test/quality-fdncnn-parity/8e9d4f77_new.mp4");
